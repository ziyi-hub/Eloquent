...
class Connection implements DriverConnection
{
    ...
    public function __construct(
        ...
        // Create default conf and event manager if none given
        if (! $config) {
    ...
    public function getHost()
    {
        Deprecation::trigger(
            ...
            'Connection::getHost() is deprecated, get the database server host from application conf ' .
    ...
    public function getPort()
    {
        Deprecation::trigger(
            'doctrine/dbal',
            'https://github.com/doctrine/dbal/issues/3580',
            'Connection::getPort() is deprecated, get the database server port from application conf ' .
            'or as a last resort from internal Connection::getParams() API.'
        );
    ...
    public function getUsername()
    {
        Deprecation::trigger(
            'doctrine/dbal',
            'https://github.com/doctrine/dbal/issues/3580',
            'Connection::getUsername() is deprecated, get the username from application conf ' .
            'or as a last resort from internal Connection::getParams() API.'
        );
    ...
    public function getPassword()
    {
        Deprecation::trigger(
            'doctrine/dbal',
            'https://github.com/doctrine/dbal/issues/3580',
            'Connection::getPassword() is deprecated, get the password from application conf ' .
            'or as a last resort from internal Connection::getParams() API.'
        );
